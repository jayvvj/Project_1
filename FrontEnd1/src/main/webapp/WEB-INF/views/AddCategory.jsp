	...
	<br>
		...
		<col width="480">
			<tr>
	    		...
	    		<td><input type="text" placeholder="Enter Category-ID" name="catid" required></input></td>
			</tr>
			<tr>
				<td><label><b>Category Name</b></label></td>
    			<td><input type="text" placeholder="Enter Category-Name" name="catname" required></input></td>
			</tr>
			<tr>
			<td />
